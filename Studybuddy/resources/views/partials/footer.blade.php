    ...
    <div class="container">
            ...
            <div class="col-md-4">
                ...
                <ul class="list-unstyled">
                    <li class="d-flex align-items-center mb-2">
                        ...
                        <span class="ml-2">StudyBuddy Official</span>
                    </li>
                    <li class="d-flex align-items-center mb-2">
                        <a href="https://instagram.com/ghandi.0210" class="btn btn-link btn-social">
                            <i class="bx bxl-instagram"></i>
                        </a>
                        <span class="ml-2">Developer Muhamad Ghandi Nur Setiawan</span>
                    </li>
                    <li class="d-flex align-items-center mb-2">
                        <a href="https://instagram.com/a.akhsanl" class="btn btn-link btn-social">
                            <i class="bx bxl-instagram"></i>
                        </a>
                        <span class="ml-2">Defeloper Andi Akhsanul</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 text-center">
                <p class="mb-0">Copyright &copy; by StudyBuddy 2023</p>
            </div>
        </div>
    </div>
</footer>
